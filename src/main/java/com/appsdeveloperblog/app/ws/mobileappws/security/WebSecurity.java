...
public class WebSecurity extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .permitAll()
        .antMatchers("/v2/api-docs", "/configuration/**", "/swagger*/swagger*/**", "/webjars/**")
        .permitAll()
        ...
        // FOR H2 DATABASE TEST PURPOSE COMMENT OUT AFTER TEST AND DONT COMMIT IT
